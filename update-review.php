...
$cur = mysqli_query($koneksi, "SELECT gambar_1, gambar_2 FROM review WHERE id_review='".intval($id_review)."' LIMIT 1");
$curRow = $cur ? mysqli_fetch_assoc($cur) : array('gambar_1'=>'','gambar_2'=>'');
